<template>
    <div class='sub-sort'>
      ...
      <div class="check">
        <XtxCheckbox @change="changeCheck" v-model="sortParams.inventory" class="xtx-checkbox">仅显示有货商品</XtxCheckbox>
        <XtxCheckbox @change="changeCheck" v-model="sortParams.onlyDiscount" class="xtx-checkbox">仅显示特惠商品</XtxCheckbox>
      </div>
    </div>
  </template>
  <script>
